...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'TikTok',
      href: 'https://www.tiktok.com/@foreigners.pl',
      icon: (
    ...
    {
      name: 'LinkedIn',
      href: 'https://www.linkedin.com/company/foreigners-pl/',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: 'YouTube',
      href: 'https://www.youtube.com/@foreigners_pl',
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="text-center md:text-left">
            ...
            <div className="space-y-4 mb-6">
              ...
              <div className="flex items-center gap-3 justify-center md:justify-start">
                ...
                <a href="https://wa.me/48736286264" className={`text-gray-600 hover:text-primary ${theme.transition.default}`}>
                  +48 736 286 264
                </a>
              </div>
            </div>
